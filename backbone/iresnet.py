...
def iresnet34(checkpoint_path):
    return _iresnet("iresnet34", IBasicBlock, [3, 4, 6, 3], checkpoint_path)


def iresnet50(checkpoint_path):
    return _iresnet("iresnet50", IBasicBlock, [3, 4, 14, 3], checkpoint_path)


def iresnet100(checkpoint_path):
