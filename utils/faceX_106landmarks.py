#  Code reused from bob.bio.face.annotator.faceX_106landmarks
...
from bob.bio.face.annotator.mtcnn import MTCNN
...
class FaceX106Landmarks(Base):
    ...
    def __init__(self, device=None, use_mtcnn_detector=True, min_size= 40,
                                   factor=0.709,
                                   thresholds=(0.6, 0.7, 0.7), **kwargs):
        self.device = torch.device("cpu") if device is None else device
        ...
        self.face_detector = MTCNN(min_size=min_size,
                                   factor=factor,
                                   thresholds=thresholds) if use_mtcnn_detector else FaceXDetector()
    ...
    def annotate(self, image, **kwargs):
        ...
        **kwargs
        ...
        return np.array(landmarks), ret_image_pre
