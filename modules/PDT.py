"""
    PDT-ID Module from https://gitlab.idiap.ch/bob/bob.paper.tifs2022_hfr_prepended_domain_transformer/
"""
...
class PDT(nn.Module): # better than the other InceptionTranslator; ~600 parameters opposed to the huge ones
    ...
    def __init__(self, in_channels=3, pool_features=6, use_se=False, use_bias=False, use_cbam=True):
        ...
        self.branch_pool = Conv2d(in_channels, pool_features, kernel_size=1, bias=self.use_bias)
