...
ROOT = "/idiap/resource/database/QMUL-SurvFace/"
TEMP = "/idiap/temp/lluevano/QMUL-SurvFace/"
BOB_TRAIN_WORLD = "./train_world_survface.csv"
RESIZED_FOLDER_NAME = "resized"
FINAL_LST_PATH = './survface_train_list.lst'
shape = (112, 112)
...
train_df.to_csv(FINAL_LST_PATH, header=False, index=False, sep=" ")
csv_file.close()
print("Done!")